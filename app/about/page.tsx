...
const content: {
  ...
  ar: {
    ...
    badge: 'دراسة حالة في معرض الأعمال — وليست وكالة تشغيلية حقيقية',
    intro: 'هذه المنصة هي دراسة حالة ضمن معرض أعمال تم تطويرها لعرض الحلول الرقمية لوكالات السفر ومشغلي الرحلات، بما في ذلك اكتشاف الوجهات وإدارة الرحلات وحجوزات السفر والخدمات الرقمية الموجهة للعملاء. يجمع المشروع بين أكثر من 20 عامًا من الخبرة في عمليات الرحلات البحرية والضيافة وتكنولوجيا السفر والتحول الرقمي.',
    author: 'Carmine D\'Alise',
    authorTitle: 'حلول رقمية للسفر والضيافة والقطاع البحري',
