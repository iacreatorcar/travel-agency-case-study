export type Lang = 'en' | 'it' | 'ru' | 'de';

export const LANGS: Lang[] = ['en', 'it', 'ru', 'de'];
...
export const tours: Tour[] = [
  {
    ...
    price: '€25',
    duration: { en: '8.5 hours', it: '8 ore e mezza', ru: '8,5 часов', de: '8,5 Stunden' },
    title: {
    ...
    pickupTime: { en: '8:00 - 16:30', it: '8:00 - 16:30', ru: '8:00 - 16:30', de: '8:00 - 16:30' },
    availability: { en: 'Daily', it: 'Tutti i giorni', ru: 'Ежедневно', de: 'Täglich' },
    highlights: {
  ...
  },
  {
    ...
    image: '/tours/private-boat/1.jpg',
    price: '€20',
    duration: { en: '6 hours', it: '6 ore', ru: '6 часов', de: '6 Stunden' },
    title: {
    ...
    pickupTime: { en: '8:00 - 14:00', it: '8:00 - 14:00', ru: '8:00 - 14:00', de: '8:00 - 14:00' },
    availability: { en: 'Daily', it: 'Tutti i giorni', ru: 'Ежедневно', de: 'Täglich' },
    highlights: {
  ...
  },
  {
    ...
    price: '€30',
    duration: { en: '10 hours', it: '10 ore', ru: '10 часов', de: '10 Stunden' },
    title: {
    ...
    pickupTime: { en: '7:00 - 17:00', it: '7:00 - 17:00', ru: '7:00 - 17:00', de: '7:00 - 17:00' },
    availability: { en: 'Friday and Sunday', it: 'Venerdì e domenica', ru: 'Пятница и воскресенье', de: 'Freitag und Sonntag' },
    highlights: {
  ...
  },
  {
    ...
    image: '/tours/safari.jpg',
    price: '€35',
    duration: { en: '11 hours', it: '11 ore', ru: '11 часов', de: '11 Stunden' },
    title: {
    ...
    pickupTime: { en: '7:00 - 18:00', it: '7:00 - 18:00', ru: '7:00 - 18:00', de: '7:00 - 18:00' },
    availability: { en: 'Daily', it: 'Tutti i giorni', ru: 'Ежедневно', de: 'Täglich' },
    highlights: {
  ...
  },
  {
    ...
    image: '/tours/safari.jpg',
    price: '€35',
    duration: { en: '9 hours', it: '9 ore', ru: '9 часов', de: '9 Stunden' },
    title: {
    ...
    pickupTime: { en: '7:00 - 16:00', it: '7:00 - 16:00', ru: '7:00 - 16:00', de: '7:00 - 16:00' },
    availability: { en: 'Monday, Thursday and Saturday', it: 'Lunedì, giovedì e sabato', ru: 'Понедельник, четверг и суббота', de: 'Montag, Donnerstag und Samstag' },
    highlights: {
  ...
  },
  {
    ...
    image: '/tours/safari.jpg',
    price: '€40',
    duration: { en: '16 hours (overnight)', it: '16 ore (notturno)', ru: '16 часов (ночная поездка)', de: '16 Stunden (Nachtfahrt)' },
    title: {
    ...
    pickupTime: { en: '22:00 - 14:00 (next day)', it: '22:00 - 14:00 (giorno dopo)', ru: '22:00 - 14:00 (на следующий день)', de: '22:00 - 14:00 (am nächsten Tag)' },
    availability: { en: 'Sunday, Wednesday and Friday', it: 'Domenica, mercoledì e venerdì', ru: 'Воскресенье, среда и пятница', de: 'Sonntag, Mittwoch und Freitag' },
    highlights: {
  ...
  },
  {
    ...
    pickupTime: { en: '7:00 - 17:00', it: '7:00 - 17:00', ru: '7:00 - 17:00', de: '7:00 - 17:00' },
    availability: { en: 'Daily except Friday and Sunday', it: 'Tutti i giorni tranne venerdì e domenica', ru: 'Ежедневно, кроме пятницы и воскресенья', de: 'Täglich außer Freitag und Sonntag' },
    highlights: {
  ...
  },
  {
    ...
    image: '/tours/safari.jpg',
    price: '€25',
    duration: { en: '1.5 hours', it: '1 ora e 30 minuti', ru: '1,5 часа', de: '1,5 Stunden' },
    title: {
      en: 'Desert Car Buggy',
    ...
    pickupTime: { en: 'Sunrise or sunset', it: 'Alba o tramonto', ru: 'Рассвет или закат', de: 'Sonnenauf- oder -untergang' },
    availability: { en: 'Daily', it: 'Tutti i giorni', ru: 'Ежедневно', de: 'Täglich' },
    highlights: {
  ...
  },
  {
    ...
    image: '/tours/safari.jpg',
    price: '€30',
    duration: { en: '4 hours', it: '4 ore', ru: '4 часа', de: '4 Stunden' },
    title: {
  ...
  },
  {
    ...
    image: '/tours/safari.jpg',
    price: '€25',
    duration: { en: '2 hours', it: '2 ore', ru: '2 часа', de: '2 Stunden' },
    title: {
  ...
  },
  {
    ...
    image: '/tours/private-boat/1.jpg',
    price: '€50',
    duration: { en: '5.5 hours', it: '5 ore e mezza', ru: '5,5 часов', de: '5,5 Stunden' },
    title: {
    ...
    pickupTime: { en: '17:00 - 22:30', it: '17:00 - 22:30', ru: '17:00 - 22:30', de: '17:00 - 22:30' },
    availability: { en: 'Daily', it: 'Tutti i giorni', ru: 'Ежедневно', de: 'Täglich' },
    highlights: {
  ...
  },
  {
    ...
    pickupTime: { en: '13:30 - 15:00', it: '13:30 - 15:00', ru: '13:30 - 15:00', de: '13:30 - 15:00' },
    availability: { en: 'Daily', it: 'Tutti i giorni', ru: 'Ежедневно', de: 'Täglich' },
    highlights: {
  ...
  },
  {
    ...
    price: '€77',
    duration: { en: '15 minutes', it: '15 minuti', ru: '15 минут', de: '15 Minuten' },
    title: {
    ...
    pickupTime: { en: 'From 10:00', it: 'Dalle 10:00', ru: 'С 10:00', de: 'Ab 10:00' },
    availability: { en: 'Daily', it: 'Tutti i giorni', ru: 'Ежедневно', de: 'Täglich' },
    highlights: {
  ...
  },
  {
    ...
    price: '€75',
    duration: { en: '7 hours', it: '7 ore', ru: '7 часов', de: '7 Stunden' },
    title: {
    ...
    pickupTime: { en: '10:00 - 17:00', it: '10:00 - 17:00', ru: '10:00 - 17:00', de: '10:00 - 17:00' },
    availability: { en: 'Daily', it: 'Tutti i giorni', ru: 'Ежедневно', de: 'Täglich' },
    highlights: {
  ...
  },
  {
    ...
    image: '/tours/private-boat/1.jpg',
    price: '€20',
    duration: { en: '20 minutes', it: '20 minuti', ru: '20 минут', de: '20 Minuten' },
    title: { en: 'Parasailing', it: 'Parasailing', ru: 'Парасейлинг', de: 'Parasailing' },
    summary: {
    ...
    pickupTime: { en: '10:00 - 17:00 (hourly slots)', it: '10:00 - 17:00 (fasce orarie)', ru: '10:00 - 17:00 (почасовые слоты)', de: '10:00 - 17:00 (Zeitfenster stündlich)' },
    availability: { en: 'Daily', it: 'Tutti i giorni', ru: 'Ежедневно', de: 'Täglich' },
    highlights: {
  ...
  },
  {
    ...
    price: '€30',
    duration: { en: '20 minutes', it: '20 minuti', ru: '20 минут', de: '20 Minuten' },
    title: { en: 'Crazy Boat', it: 'Crazy Boat', ru: 'Крейзи-бот', de: 'Crazy Boat' },
    summary: {
  ...
  },
  {
    ...
    image: '/tours/private-boat/1.jpg',
    price: '€20',
    duration: { en: '11 minutes', it: '11 minuti', ru: '11 минут', de: '11 Minuten' },
    title: { en: 'Tube Boat', it: 'Tube Boat', ru: 'Тюб-бот', de: 'Tube Boat' },
    summary: {
  ...
  },
  {
    ...
    price: '€20',
    duration: { en: '11 minutes', it: '11 minuti', ru: '11 минут', de: '11 Minuten' },
    title: { en: 'Banana Boat', it: 'Banana Boat', ru: 'Банан-бот', de: 'Bananenboot' },
    summary: {
  ...
  },
  {
    ...
    price: '€28',
    duration: { en: '11 minutes', it: '11 minuti', ru: '11 минут', de: '11 Minuten' },
    title: { en: 'Water Skiing', it: 'Sci d\'acqua', ru: 'Водные лыжи', de: 'Wasserski' },
    summary: {
  ...
  },
  {
    ...
    price: '€20',
    duration: { en: '11 minutes', it: '11 minuti', ru: '11 минут', de: '11 Minuten' },
    title: { en: 'Water Donut', it: 'Ciambelle all\'acqua', ru: 'Водный пончик', de: 'Water Donut' },
    summary: {
  ...
  },
  {
    ...
    image: '/tours/private-boat/1.jpg',
    price: '€40',
    duration: { en: '1 hour', it: '1 ora', ru: '1 час', de: '1 Stunde' },
    title: { en: 'Private Speedboat', it: 'Motoscafo privato', ru: 'Частный катер', de: 'Privates Speedboot' },
    summary: {
  ...
  },
  {
    ...
    pickupTime: { en: '8:00 - 16:30 (hourly slots)', it: '8:00 - 16:30 (fasce orarie)', ru: '8:00 - 16:30 (почасовые слоты)', de: '8:00 - 16:30 (Zeitfenster stündlich)' },
    availability: { en: 'Daily', it: 'Tutti i giorni', ru: 'Ежедневно', de: 'Täglich' },
    highlights: {
  ...
  },
  {
    ...
    price: '€10',
    duration: { en: '1 hour', it: '1 ora', ru: '1 час', de: '1 Stunde' },
    title: { en: 'Glass Boat', it: 'Barca di vetro', ru: 'Лодка со стеклянным дном', de: 'Glasbodenboot' },
    summary: {
    ...
    pickupTime: { en: '10:00 - 16:00 (hourly slots)', it: '10:00 - 16:00 (fasce orarie)', ru: '10:00 - 16:00 (почасовые слоты)', de: '10:00 - 16:00 (Zeitfenster stündlich)' },
    availability: { en: 'Daily', it: 'Tutti i giorni', ru: 'Ежедневно', de: 'Täglich' },
    highlights: {
  ...
  },
  {
    ...
    price: '€40',
    duration: { en: '2 hours', it: '2 ore', ru: '2 часа', de: '2 Stunden' },
    title: { en: 'Submarine Tour', it: 'Sottomarino', ru: 'Экскурсия на подводной лодке', de: 'U-Boot-Tour' },
    summary: {
    ...
    pickupTime: { en: '9:00 - 14:00 (2-hour slots)', it: '9:00 - 14:00 (fasce da 2 ore)', ru: '9:00 - 14:00 (2-часовые слоты)', de: '9:00 - 14:00 (2-Stunden-Zeitfenster)' },
    availability: { en: 'Daily', it: 'Tutti i giorni', ru: 'Ежедневно', de: 'Täglich' },
    highlights: {
  ...
  },
  {
    ...
    price: '€25',
    duration: { en: '1 hour', it: '1 ora', ru: '1 час', de: '1 Stunde' },
    title: { en: 'Scuba Diving in Naama Bay', it: 'Immersioni a Naama Bay', ru: 'Дайвинг в Наама-Бей', de: 'Gerätetauchen in Naama Bay' },
    summary: {
  ...
  },
  {
    ...
    price: '€65',
    duration: { en: '24 hours (overnight)', it: '24 ore (notturno)', ru: '24 часа (ночная поездка)', de: '24 Stunden (Nachtfahrt)' },
    title: {
      en: 'Cairo by Bus',
    ...
    pickupTime: { en: '23:00 - 23:00 (next day, approx.)', it: '23:00 - 23:00 (giorno dopo, circa)', ru: '23:00 - 23:00 (на следующий день, ориентировочно)', de: '23:00 - 23:00 (am nächsten Tag, ca.)' },
    availability: { en: 'Daily', it: 'Tutti i giorni', ru: 'Ежедневно', de: 'Täglich' },
    highlights: {
  ...
  },
  {
    ...
    price: '€190',
    duration: { en: '15 hours', it: '15 ore', ru: '15 часов', de: '15 Stunden' },
    title: {
      en: 'Cairo by Plane',
    ...
    pickupTime: { en: '6:00 - 21:00', it: '6:00 - 21:00', ru: '6:00 - 21:00', de: '6:00 - 21:00' },
    availability: { en: 'Sunday and Wednesday', it: 'Domenica e mercoledì', ru: 'Воскресенье и среда', de: 'Sonntag und Mittwoch' },
    highlights: {
  ...
  },
  {
    ...
    pickupTime: { en: '6:00 - 21:00', it: '6:00 - 21:00', ru: '6:00 - 21:00', de: '6:00 - 21:00' },
    availability: { en: 'Wednesday, Friday and Saturday', it: 'Mercoledì, venerdì e sabato', ru: 'Среда, пятница и суббота', de: 'Mittwoch, Freitag und Samstag' },
    highlights: {
  ...
  },
  {
    ...
    price: '€270',
    duration: { en: '22 hours', it: '22 ore', ru: '22 часа', de: '22 Stunden' },
    title: {
    ...
    pickupTime: { en: '1:00 - 23:00', it: '1:00 - 23:00', ru: '1:00 - 23:00', de: '1:00 - 23:00' },
    availability: { en: 'Daily', it: 'Tutti i giorni', ru: 'Ежедневно', de: 'Täglich' },
    highlights: {
  ...
  },
  {
    ...
    price: '€176',
    duration: { en: '27 hours (overnight)', it: '27 ore (notturno)', ru: '27 часов (ночная поездка)', de: '27 Stunden (Nachtfahrt)' },
    title: {
      en: 'Jerusalem by Bus',
    ...
    pickupTime: { en: '20:00 - 23:00 (next day)', it: '20:00 - 23:00 (giorno dopo)', ru: '20:00 - 23:00 (на следующий день)', de: '20:00 - 23:00 (am nächsten Tag)' },
    availability: { en: 'Saturday, Monday and Thursday', it: 'Sabato, lunedì e giovedì', ru: 'Суббота, понедельник и четверг', de: 'Samstag, Montag und Donnerstag' },
    highlights: {
